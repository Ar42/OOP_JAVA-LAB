...
package ObjectPassingMethodInstance;
...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        else if ( s1.equal(s2) == 2)
                   System.out.println("Same Dept But Not Same Year");
        else  if ( s1.equal(s2) == 3) 
                   System.out.println("Not Same Dept But Same Year");
